...
export function Ventas() {
  ...
  const [simulatedData, setSimulatedData] = useState({
    ...
    topProducts: [
      { id: 'PRD001', name: 'Producto A', sales: 25, revenue: 45000 },
      { id: 'PRD002', name: 'Producto B', sales: 18, revenue: 32000 },
      { id: 'PRD003', name: 'Producto C', sales: 15, revenue: 28000 },
      { id: 'PRD004', name: 'Producto D', sales: 12, revenue: 21000 },
      { id: 'PRD005', name: 'Producto E', sales: 10, revenue: 18000 },
      { id: 'PRD006', name: 'Producto F', sales: 8, revenue: 15000 },
      { id: 'PRD007', name: 'Producto G', sales: 7, revenue: 12000 },
      { id: 'PRD008', name: 'Producto H', sales: 6, revenue: 10000 },
      { id: 'PRD009', name: 'Producto I', sales: 5, revenue: 8500 },
      { id: 'PRD010', name: 'Producto J', sales: 4, revenue: 7000 },
    ],
    performanceAlerts: [
      {
        type: 'warning',
